...
export default function ChapterTransition({ line, nextNumber }: ChapterTransitionProps) {
  return (
    <div className="relative z-10 flex flex-col items-center py-20 px-6">
      ...
      />
      <div className="w-1.5 h-1.5 rounded-full bg-accent-cyan my-3 opacity-60" />
      <motion.div
      ...
      >
        <span className="font-body text-[9px] uppercase tracking-[0.3em] text-accent-vio italic">
          Chapter {nextNumber}
        </span>
